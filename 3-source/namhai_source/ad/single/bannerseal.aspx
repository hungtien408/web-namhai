<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="bannerseal.aspx.cs" Inherits="ad_single_advertisement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                    ...
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">
                                Thông Tin Banner Seal Niêm Phong</h3>
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 1260px x 320px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="AdsBannerDelete"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="9" Name="AdsCategoryID" PropertyName="SelectedValue"
                Type="String" />
