        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" AllowPaging="True" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="ArticleTitle" HeaderText="Tên công ty" SortExpression="ArticleTitle" />
                    <asp:GridBoundColumn DataField="Tag" HeaderText="Điện thoại" SortExpression="Tag" />
                    <asp:GridBoundColumn DataField="MetaTittle" HeaderText="Fax" SortExpression="MetaTittle" />
