...
public partial class ad_single_photoalbum : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string strProductCategoryID = "2";//((RadComboBox)row.FindControl("ddlCategory")).SelectedValue;
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                if (!string.IsNullOrEmpty(strImageName))
                {
                    ...
                    ResizeCropImage.ResizeByCondition(strFullPath, 900, 900);
                    ResizeCropImage.CreateThumbNailByCondition("~/res/photoalbumcategory/", "~/res/photoalbumcategory/thumbs/", strImageName, 115, 91);
                }
            ...
            else
            {
                ...
                dsUpdateParam["ProductCategoryID"].DefaultValue = strProductCategoryID;
    ...
    protected void FileImageAlbum_FileUploaded(object sender, FileUploadedEventArgs e)
    {
        ...
        ResizeCropImage.ResizeByCondition(targetFolder + newName, 900, 900);
