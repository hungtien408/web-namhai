<%@ Page Title="" Language="C#" MasterPageFile="~/site-partner.master" AutoEventWireup="true"
    CodeFile="thiet-ke-in-an.aspx.cs" Inherits="thiet_ke_in_an" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container-bg">
        <asp:HiddenField ID="hdnThietKeInAn" runat="server" />
        <a class="a-link-tkia" href="<%= hdnThietKeInAn.Value %>"></a>
        ...
        <div class="container">
            <%--<div class="list-product">
                <a class="active" href="thiet-ke-in-an.aspx">Tất cả</a>
                <asp:ListView ID="lstDesignCategory" runat="server" DataSourceID="odsDesignCategory"
                    EnableModelValidation="True">
                    <ItemTemplate>
                        <a href='<%# progressTitle(Eval("ProductCategoryName")) + "-dci-" + Eval("ProductCategoryID") + ".aspx" %>'>
            ...
            <div class="row product-tb">
                <asp:ListView ID="lstDesign" runat="server" DataSourceID="odsDesign" EnableModelValidation="True">
                    <ItemTemplate>
                            ...
                            <div class="product-box scale-animate">
                                <div class="product-img">
                                    <a href='<%# progressTitle(Eval("ProductName")) + "-dci-" + Eval("CategoryID") + "-pi-" + Eval("ProductID") + ".aspx" %>'>
                                        <img class="hideo" alt='<%# Eval("ImageName") %>' src='<%# !string.IsNullOrEmpty(Eval("ImageName").ToString()) ? "~/res/product/" + Eval("ImageName") : "~/assets/images/img1.jpg" %>' runat="server" />
                                    </a>
                                </div>
                                <h4 class="product-name">
                                    <a href='<%# progressTitle(Eval("ProductName")) + "-dci-" + Eval("CategoryID") + "-pi-" + Eval("ProductID") + ".aspx" %>'><%# Eval("ProductName") %></a></h4>
                            </div>
                        </div>
                    </ItemTemplate>
                    <LayoutTemplate>
                ...
                <asp:ObjectDataSource ID="odsDesign" runat="server" 
                    ...
                    <SelectParameters>
                        ...
                        <asp:QueryStringParameter DefaultValue="1" Name="CategoryID" QueryStringField="dci" 
                            Type="String" />
            ...
            <div class="pager">
                <asp:DataPager ID="DataPager1" runat="server" PageSize="12" PagedControlID="lstDesign">
                    <Fields>
